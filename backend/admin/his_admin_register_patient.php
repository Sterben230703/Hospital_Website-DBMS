...
<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['add_patient']))
		{
            ...
            $rollNumberPattern = '/^(18|19|20|21|22|23)(bcs|bec|bme|pcs|pec|mcs|mec|bsm|bds)\d{3}$/i';

            if (!preg_match($rollNumberPattern, $pat_number)) {
                // Roll number does not match the required format
                $err = "Invalid Roll Number Format. Please enter a valid roll number.";
            } else {
           
            //sql to insert captured values
			$query="insert into his_patients (pat_fname,pat_lname, pat_age, pat_dob, roll_no, pat_phone,pat_addr) values(?,?,?,?,?,?,?)";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('sssssss', $pat_fname,$pat_lname, $pat_age, $pat_dob, $pat_number, $pat_phone, $pat_addr);
			$stmt->execute();
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <label for="inputCity" class="col-form-label">Roll Number</label>
                                                    <input required="required" type="text" name="roll_no" class="form-control" id="inputroll">
                                                </div>
